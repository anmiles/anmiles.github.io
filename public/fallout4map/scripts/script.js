...
if (editable) {
	map.addControl(new L.Button({ position: 'topright', hotkey: null, text: lang.addPoint, click: () => addPoint() }));
	map.addControl(new L.Button({ position: 'topright', hotkey: null, text: lang.copyPoints, click: () => copyPoints() }));
}
